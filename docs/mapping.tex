...
Using MinHash, we can estimate this similarity by comparing minmer sketches, where each minmer is the k-mer with the smallest hash value within a window of consecutive k-mers. The probability that two sketches share a minmer is approximately equal to the Jaccard similarity.
