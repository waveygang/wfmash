...
\time -v ./bin/align_benchmark -a gap-affine-wfa -i ../data/sim.l100.n100K.e2.seq --memory-mode=med -o sim.l100.e2.Wl.alg     &> sim.l100.e2.Wl.log
...
\time -v ./bin/align_benchmark -a gap-affine-wfa -i ../data/sim.l1K.n10K.e20.seq --memory-mode=med -o sim.l1K.e20.Wl.alg      &> sim.l1K.e20.Wl.log
...
\time -v ./bin/align_benchmark -a gap-affine-wfa -i ../data/sim.l10K.n1K.e20.seq --memory-mode=med -o sim.l10K.e20.Wl.alg     &> sim.l10K.e20.Wl.log
...
# Other
\time -v ./bin/align_benchmark -a gap-affine-wfa   -i ../data/sim.l100K.n1.e10.seq -o sim.l100K.e10.Wl.alg --memory-mode=med  &> sim.l100K.e10.Wl.log
