// version.hpp: Version reflection information for wfmash builds.
...
namespace wfmash {
    ...
    /// Class for holding wfmash version.
    class Version {
    public:
        /// The Git version description of this build of wfmash
        const static string VERSION;

        /// Get only the version (like v1.7.0-68-g224e7625).
        static string get_version();

        /// Get the release Git tag version of wfmash that the current version
        ...
        /// Get a short one-line description of the current version of wfmash with no terminating newline.
